...
custom_replacements = {
  ...
  */
  names = {
    ...
    management_resource_group_name                 = "git-rg-management-$${starter_location_01}"
    connectivity_hub_primary_resource_group_name   = "git-rg-hub-$${starter_location_01}"
    connectivity_hub_secondary_resource_group_name = "git-rg-hub-$${starter_location_02}"
    dns_resource_group_name                        = "git-rg-hub-dns-$${starter_location_01}"
    #ddos_resource_group_name                       = "rg-hub-ddos-$${starter_location_01}"
    asc_export_resource_group_name                 = "git-rg-asc-export-$${starter_location_01}"

    # Resource names
    log_analytics_workspace_name            = "git-law-management-$${starter_location_01}"
    #ddos_protection_plan_name               = "ddos-$${starter_location_01}"
    ama_user_assigned_managed_identity_name = "git-uami-management-ama-$${starter_location_01}"
    dcr_change_tracking_name                = "git-dcr-change-tracking"
    dcr_defender_sql_name                   = "git-dcr-defender-sql"
    dcr_vm_insights_name                    = "git-dcr-vm-insights"

    # Resource names primary connectivity
    primary_virtual_network_name                                 = "git-vnet-hub-$${starter_location_01}"
    primary_subnet_nva_name_pub_1                                = "git-subnet-nva-pub-$${starter_location_01}"
    primary_subnet_nva_name_mgmt_1                               = "git-subnet-nva-mgmt-$${starter_location_01}"
    primary_subnet_nva_name_pri_1                                = "git-subnet-nva-pri-$${starter_location_01}"                   
    primary_route_table_firewall_name                            = "git-rt-hub-fw-$${starter_location_01}"
    primary_route_table_user_subnets_name                        = "git-rt-hub-std-$${starter_location_01}"
    primary_virtual_network_gateway_express_route_name           = "git-vgw-hub-er-$${starter_location_01}"
    primary_virtual_network_gateway_express_route_public_ip_name = "git-pip-vgw-hub-er-$${starter_location_01}"
    primary_virtual_network_gateway_vpn_name                     = "git-vgw-hub-vpn-$${starter_location_01}"
    primary_virtual_network_gateway_vpn_public_ip_name_1         = "git-pip-vgw-hub-vpn-$${starter_location_01}-001"
    primary_virtual_network_gateway_vpn_public_ip_name_2         = "git-pip-vgw-hub-vpn-$${starter_location_01}-002"
    primary_private_dns_resolver_name                            = "git-pdr-hub-dns-$${starter_location_01}"
    primary_bastion_host_name                                    = "git-bas-hub-$${starter_location_01}"
    primary_bastion_host_public_ip_name                          = "git-pip-bastion-hub-$${starter_location_01}"
    ...
    primary_nva_subnet_address_prefix_pri_1            = "10.136.64.32/27"
...
tags = {
  ...
  source      = "git-Azure Landing Zones Accelerator"
}
  ...
  primary = {
    hub_virtual_network = {
      ...
      subnets = {
        ...
        pri = {
          name             = "$${primary_subnet_nva_name_pri_1}"
          address_prefixes = ["$${primary_nva_subnet_address_prefix_pri_1}"]
        }
      }
    }
